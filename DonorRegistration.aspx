<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DonorRegistration.aspx.cs" Inherits="NGOService.DonorRegistration" %>
...
<body>
    <div class="form">
        ...
        <div class="form-content">
            ...
            <div class="form-info">
                <h2>
                    Donor Registration</h2>
            </div>
            <div class="pass1">
                <label>
                    Donor Name</label>
                <asp:TextBox ID="txtName" class="input1" runat="server" placeholder="Donor Name"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Enter Donor Name"
